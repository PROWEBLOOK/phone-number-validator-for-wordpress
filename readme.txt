...
This plugin uses the Proweblook Phone-Validator API (https://proweblook.com) to check if a phone number is really valid and callable.
...
Phone-Validator is a service operated by Proweblook, a company located in Germany and operating according to EU General Data Protection Regulation (GDPR) standards and the German Federal Data Protection Act (BDSG) - one of the strictest data protection and privacy legislations in the world (see http://en.wikipedia.org/wiki/Bundesdatenschutzgesetz for details). 
